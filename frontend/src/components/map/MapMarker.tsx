          ...
          {crowdData ? (
            <div className="space-y-1 text-sm">
              <p className="flex justify-between">
                <span>People:</span> <span className="font-semibold">{crowdData.peopleCount}</span>
              </p>
              <p className="flex justify-between">
                <span>Density:</span>{' '}
                <span className={`font-semibold text-${color}-500`}>{crowdData.density}</span>
              </p>
              <p className="flex justify-between">
                <span>Queue:</span>{' '}
                <span className="font-semibold">{crowdData.queueTime} mins</span>
              </p>
            </div>
          ) : (
