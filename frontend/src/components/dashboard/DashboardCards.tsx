...
export function DashboardCards({ totalAttendance, activeIncidents, avgQueueTime, availableVolunteers }: DashboardCardsProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 shrink-0" aria-label="Dashboard Statistics" aria-live="polite">
      {[
