  ...
  return (
    ...
    >
      ...
      <div className="mt-auto pt-6 border-t border-white/10 flex flex-col gap-2">
        <a
          href="/operations"
          className="flex items-center gap-3 px-4 py-3 rounded-lg cursor-pointer bg-purple-500/10 text-purple-400 border border-purple-500/20 hover:bg-purple-500/20 transition-all font-medium"
        >
          <Activity size={18} />
        ...
        <a
          href="/emergency"
          className="flex items-center gap-3 px-4 py-3 rounded-lg cursor-pointer bg-red-500/10 text-red-400 border border-red-500/20 hover:bg-red-500/20 transition-all font-medium"
        >
          <ShieldAlert size={18} />
