      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <select
            ...
            className="w-full bg-black/40 border border-white/10 rounded-lg px-3 py-2 text-sm text-white [&>option]:bg-zinc-900"
          >
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Details..."
            className="w-full bg-black/40 border border-white/10 rounded-lg px-3 py-2 text-sm text-white min-h-[60px]"
          ></textarea>
        ...
        <button
          disabled={submitting}
          type="submit"
          className="w-full bg-red-600 hover:bg-red-500 text-white font-medium py-2 rounded-lg transition-colors text-sm disabled:opacity-50"
        >
