...
from services.prompts import DECISION_PROMPTS, DECISION_FALLBACKS
...
class GeminiService:
    ...
    async def get_decision_recommendation(self, context_data: dict) -> dict:
        ...
        prompt_template = DECISION_PROMPTS.get(mode, DECISION_PROMPTS["default"])
        prompt = prompt_template.format(context_str=context_str)
        
        fallback = DECISION_FALLBACKS.get(mode, DECISION_FALLBACKS["default"])
