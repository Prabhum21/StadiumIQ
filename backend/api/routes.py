...
from schemas.api_models import (
    ...
    MultilingualAssistRequest, MultilingualAssistResponse
)
...
@limiter.limit("10/minute")
async def sustainability_endpoint(request: Request, payload: SustainabilityRequest) -> SustainabilityResponse:
    """
...
@limiter.limit("20/minute")
async def multilingual_assist_endpoint(request: Request, payload: MultilingualAssistRequest) -> MultilingualAssistResponse:
    """
    ...
    response_text = await gemini_service.get_fan_assistant_response(query=query, user_profile={"language": payload.target_language})
